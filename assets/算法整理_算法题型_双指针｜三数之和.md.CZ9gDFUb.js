import{_ as s,c as n,o as p,a1 as e}from"./chunks/framework.CPsxJxQM.js";const f=JSON.parse('{"title":"问题","description":"","frontmatter":{},"headers":[],"relativePath":"算法整理/算法题型/双指针｜三数之和.md","filePath":"算法整理/算法题型/双指针｜三数之和.md"}'),l={name:"算法整理/算法题型/双指针｜三数之和.md"};function t(i,a,r,c,h,o){return p(),n("div",null,a[0]||(a[0]=[e(`<h1 id="问题" tabindex="-1">问题 <a class="header-anchor" href="#问题" aria-label="Permalink to &quot;问题&quot;">​</a></h1><p>求数组内任意三个数之和为0的组合（子数组）有哪些，不能重复</p><h2 id="思路" tabindex="-1">思路 <a class="header-anchor" href="#思路" aria-label="Permalink to &quot;思路&quot;">​</a></h2><p>对数组排序，对三个数定义为 i left=i+1 right=len-1</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>其中i为数组遍历的下标，范围 [0, len-2)</span></span>

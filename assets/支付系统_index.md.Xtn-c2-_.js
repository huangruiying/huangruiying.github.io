import{_ as a,c as n,o as i,a1 as p}from"./chunks/framework.CPsxJxQM.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"支付系统/index.md","filePath":"支付系统/index.md"}'),e={name:"支付系统/index.md"};function l(t,s,h,c,r,E){return i(),n("div",null,s[0]||(s[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>会介绍直连间连区别，应用场景，使用方式及区别</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">商户号：支付通道的商户号mch_no</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">服务商号：isv_no</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">商户类型: 1-普通商户, 2-特约商户(服务商模式)</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">支付金额(分)：用户应该在支付通道支付的实际金额。</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">支付状态：待支付、支付成功、超时关单、主动关单...</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">退款状态: 0-未发生实际退款, 1-部分退款, 2-全额退款</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">退款次数: </span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">退款总金额(分):</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">页面跳转地址：ReturnUrl http://xxxxxws</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">签约结果通知：SignNotifyUrl http://xxxxxws，一般用于支付即签约的场景。</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">向下游回调状态: 0-未发送,  1-已发送&#39;</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">支付通道用户身份：third_identity_id 标识支付通道的用户标识。</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">客户端IP：</span></span></code></pre></div><h2 id="支付路由表核心字段" tabindex="-1">支付路由表核心字段 <a class="header-anchor" href="#支付路由表核心字段" aria-label="Permalink to &quot;支付路由表核心字段&quot;">​</a></h2><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">业务线标识</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">支付产品：</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">收单通道：</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">商户号：</span></span></code></pre></div><h2 id="支付与业务方的对接模式有哪些" tabindex="-1">支付与业务方的对接模式有哪些 <a class="header-anchor" href="#支付与业务方的对接模式有哪些" aria-label="Permalink to &quot;支付与业务方的对接模式有哪些&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>对接渠道的模式</span></span>
...
<span class="line"><span>    支付参数获取 PayParamApi</span></span></code></pre></div><h2 id="支付收单服务全流程" tabindex="-1">支付收单服务全流程 <a class="header-anchor" href="#支付收单服务全流程" aria-label="Permalink to &quot;支付收单服务全流程&quot;">​</a></h2><p><a href="./支付收单服务全流程.html">支付收单服务全流程</a></p><h2 id="各通道都有哪些支付产品" tabindex="-1">各通道都有哪些支付产品? <a class="header-anchor" href="#各通道都有哪些支付产品" aria-label="Permalink to &quot;各通道都有哪些支付产品?&quot;">​</a></h2><p><a href="./支付产品与各支付通道的类型映射.html">支付产品与各支付通道的类型映射</a></p><h2 id="支付异步退款流程" tabindex="-1">支付异步退款流程 <a class="header-anchor" href="#支付异步退款流程" aria-label="Permalink to &quot;支付异步退款流程&quot;">​</a></h2><p><a href="./异步退款流程设计.html">异步退款流程设计.md</a></p>`,13)]))}const o=a(e,[["render",l]]);export{d as __pageData,o as default};

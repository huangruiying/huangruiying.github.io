import{_ as a,c as n,o as i,a1 as p}from"./chunks/framework.BMsMDqYY.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"支付系统/index.md","filePath":"支付系统/index.md"}'),e={name:"支付系统/index.md"};function l(t,s,h,c,r,E){return i(),n("div",null,s[0]||(s[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>会介绍直连间连区别，应用场景，使用方式及区别</span></span>
